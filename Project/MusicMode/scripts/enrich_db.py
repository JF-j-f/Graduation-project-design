...
# ============================================================
KKBOX_LANG_MAP = {
    # 经 ISRC 国家码交叉验证修正（2026-03-24）
    # 验证方法：将 songs.csv 与 song_extra_info.csv 按 song_id 关联，
    #          提取 ISRC 前2位国家码，按 language 编码分组统计国家码分布，
    #          根据主导国家/地区反推语种含义。
    "-1": "未知",       # 无语言信息，ISRC 分布为混合西洋音乐
    "3":  "国语",       # ISRC 验证: TW 71%, HK 16%, CN 6% → 华语区
    "10": "台语",       # ISRC 验证: TW 97% → 台湾本土音乐（闽南语）
    "17": "日语",       # ISRC 验证: JP 88%
    "24": "粤语",       # ISRC 验证: HK 96% → 香港粤语歌
    "31": "韩语",       # ISRC 验证: KR 80% → 韩国 K-Pop
    "38": "印度语",     # ISRC 验证: IN 76% → 印度音乐
    "45": "泰语",       # ISRC 验证: TH 99.6% → 泰国音乐
    "52": "英语",       # ISRC 验证: US 37%, GB 16%, DE 10% → 西洋音乐
    "59": "马来语",     # ISRC 验证: MY 77%, ID 20% → 马来/印尼音乐
}
