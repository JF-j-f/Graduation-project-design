                                        ...
                                        <% } %>
                                                    ...
                                                    <div class="login-card-wrapper">
                                                        ...
                                                        <form action="userLogin" method="post">
                                                            <div class="input-group">
                                                                <input type="text" name="username" class="modern-input"
                                                                    placeholder="请输入用户名/手机号" required>
                                                            </div>
                                                            <div class="input-group">
                                                                <input type="password" name="password"
                                                                    class="modern-input" placeholder="请输入密码" required>
                                                            </div>
                                                            ...
                                                            <div
                                                                style="text-align: center; margin-top: 1.5rem; font-size: 0.9rem;">
                                                                还没有账号？ <a href="register.jsp"
                                                                    style="color: var(--primary-color); font-weight: bold;">去注册</a>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                                            ...
                                            <section class="features-section">
                                                <div class="features-container">
                                                    <h2
                                                        style="text-align: center; margin-bottom: 3rem; font-size: 2rem;">
                                                        为什么选择 MusicWeb</h2>
                                                                ...
                                                                <div class="song-item" style="background: white;">
                                                                    <div class="song-cover">
                                                                        <% if(song.getCoverImage() !=null &&
                                                                            ...
                                                                            coverUrl=song.getCoverImage(); if
                                                                            (!coverUrl.startsWith("http") &&
                                                                            !coverUrl.startsWith("/")) {
                                                                            coverUrl=request.getContextPath() + "/" +
                                                                            coverUrl; } %>
                                                                ...
                                                                <% } %>
                                                                    ...
                                                                    <% if(recommendedSongs.isEmpty()) { %>
                                                                        ...
                                                                        <% } %>
                                                                            ...
                                                                            <div class="song-item"
                                                                                style="background: white;">
                                                                                <div style="display: flex; align-items: center; justify-content: center; width: 100%; height: 100%; color: var(--primary-color); cursor: pointer;"
                                            ...
                                            <!-- 页脚 -->
                                            <footer
                                                style="background: #333; color: #999; padding: 3rem 0; margin-top: 0;">
