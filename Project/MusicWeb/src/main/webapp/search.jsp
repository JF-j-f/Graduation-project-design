    ...
    <%@ page import="com.music.javabean.*, com.music.dao.*, java.util.*" %>
        <% User user=(User) session.getAttribute("user"); if (user==null) { response.sendRedirect("index.jsp"); return;
            ...
            request.getAttribute("source"); @SuppressWarnings("unchecked") List<Song> searchResults = (List<Song>)
                ...
                // v3.3.0: 用于判断收藏状态（使用 Redis 缓存）
                PlaylistDAO playlistDAO = new PlaylistDAO();
                Set<String> favoritedKeys = playlistDAO.getFavoritedSongKeys(user.getId());
                                ...
                                <section class="search-section">
                                    <div class="search-wrapper">
                                        <form action="search" method="get" id="search-form">
                                            <div class="google-search-bar">
                                                ...
                                                <input type="text" name="keyword" id="search-input"
                                                    value="<%= keyword %>" class="google-search-input"
                                                    placeholder="搜索你喜欢的音乐..." autocomplete="off">
                                                <!-- 右侧按钮 -->
                                        ...
                                        <div class="source-selector">
                                            <button type="button" class="source-btn <%= " netease".equals(source)
                                                ? "active" : "" %>"
                                ...
                                <section>
                                    ...
                                    <% if (searchResults.isEmpty()) { %>
                                        <div class="empty-state">
                                            ...
                                            <h3>未找到相关歌曲</h3>
                                            <p>试试其他关键词吧，或者 <a href="user.jsp"
                                                    style="color: var(--primary-color);">返回首页</a>
                                            </p>
                                        </div>
                                        <% } else { %>
                                            <div class="song-list">
                                                    ...
                                                    <div class="song-item fade-in">
                                                        ...
                                                        <div class="song-info">
                                                            <div class="song-title">
                                                                <%= song.getTitle() %>
                                                                    <% if (isExternal) { %>
                                                                        <span
                                                                            class="source-tag source-<%= songSource %>">
                                                                            <%= "netease" .equals(songSource) ? "网易云"
                                                                                : "QQ" %>
                                                                        </span>
                                                                        <% } %>
                                                                            <% if (song.isVip()) { %>
                                                        ...
                                                        <div class="song-actions">
                                                            ...
                                                            <% String songKey=song.getTitle() + "|" + song.getArtist();
                                                                boolean isFavorited=favoritedKeys.contains(songKey); %>
                            ...
                            <script>
                                ...
                                document.addEventListener('DOMContentLoaded', function () {
                                    ...
                                    document.querySelectorAll('.play-btn').forEach(playBtn => {
                                        ...
                                        const isFavorited = playBtn.dataset.favorited === 'true';
                                        ...
                                        playBtn.parentNode.insertBefore(favBtn, playBtn);
                                    });
