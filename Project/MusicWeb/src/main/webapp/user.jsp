                                                                ...
                                                                <body>
                                                                    ...
                                                                    <header class="header">
                                                                        <div class="nav-container">
                                                                            ...
                                                                            <div class="user-info">
                                                                                ...
                                                                                <a href="logout"
                                                                                    class="btn btn-outline">退出</a>
                                                                                <a href="settings.jsp"
                                                                                    class="btn btn-secondary">⚙️ 设置</a>
                                                                            </div>
                                                                        </div>
                                                                    </header>
                                                                    ...
                                                                    <main class="main-container">
                                                                        ...
                                                                        <section id="discover"
                                                                            ...
                                                                            <div class="song-list" id="recommend-list">
                                                                        ...
                                                                        <!-- 热门排行榜 -->
                                                                        <section id="charts" style="margin-top: 3rem;">
                                                                    ...
                                                                    <script src="js/user-logic.js"></script>
                                                                </body>
