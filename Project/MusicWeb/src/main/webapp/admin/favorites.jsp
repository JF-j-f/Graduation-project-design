            ...
            <div style="overflow-x: auto;">
                <table class="favorites-table" id="favoritesTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" class="favorite-checkbox" value="<%= favorite.getId() %>" onchange="updateSelectAll()">
                                <span class="favorite-id" style="margin-left: 0.5rem;">#<%= favorite.getId() %></span>
                            </td>
                            <td>
                                <span class="user-name">
                                    <%= favorite.getUser() != null ? favorite.getUser().getUsername() : "未知用户" %>
                                </span>
                            </td>
                            <td>
                                <span class="song-title">
                                    <%= favorite.getSong() != null ? favorite.getSong().getTitle() : "未知歌曲" %>
                                </span>
                            </td>
                            <td>
                                <span class="time-stamp">
                                    <%= favorite.getCreateTime() != null ? favorite.getCreateTime().substring(0, 16) : "未知时间" %>
                                </span>
                            </td>
                            <td>
                                <div class="favorite-actions">
                                    <button class="btn-small btn-view" onclick="viewFavoriteDetails(<%= favorite.getId() %>)">
                                        👁️ 详情
                                    </button>
                                    <button class="btn-small btn-delete" onclick="deleteFavorite(<%= favorite.getId() %>)">
                                        🗑️ 删除
                                    </button>
                                </div>
                            </td>
