            ...
            <div class="user-details-grid">
                ...
                <div class="user-info-card">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value"><%= user.getNickname() != null ? user.getNickname() : "未设置" %></div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value"><%= user.getCreateTime() != null ? user.getCreateTime().substring(0, 16) : "未知" %></div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value"><%= user.getFrozenUntil() != null ? user.getFrozenUntil().substring(0, 16) : "未知" %></div>
                    </div>

                    <div class="info-item">
                        <div class="info-label">冻结原因</div>
                        <div class="info-value"><%= user.getFrozenReason() != null ? user.getFrozenReason() : "未说明" %></div>
                    </div>
                    <% } %>
                </div>
                ...
                <div class="user-actions-card">
                    ...
                    <div class="action-section">
                        ...
                        <form id="freezeForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="datetime-local" name="frozenUntil" class="form-input" required>
                            </div>

                            <div class="form-group">
                                <label class="form-label">冻结原因</label>
                                <textarea name="reason" class="form-input" rows="3" placeholder="请输入冻结原因..." required></textarea>
                            </div>

                            <button type="button" class="btn-warning" style="width: 100%;" onclick="submitFreeze()">确认冻结</button>
                        </form>
                    </div>
                    ...
                    <div class="action-section">
                        ...
                        <button type="button" class="btn-success" style="width: 100%;" onclick="submitUnfreeze(<%= user.getId() %>)">立即解冻</button>
                    </div>
                    <% } %>
                    ...
                    <div class="action-section">
                        ...
                        <button type="button" class="btn-danger" style="width: 100%;" onclick="submitDelete('<%= user.getUsername() %>')">删除用户</button>
                    </div>
                </div>
            </div>
        </div>
