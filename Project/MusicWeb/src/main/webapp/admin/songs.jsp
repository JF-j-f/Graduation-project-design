                ...
                <div class="admin-container">
                    ...
                    <div class="admin-content">
                        ...
                        <% String message=request.getParameter("message"); String
                            messageType=request.getParameter("messageType"); if (message !=null && !message.isEmpty()) {
                            String bgColor="success" .equals(messageType) ? "#d4edda" : "#f8d7da" ; String
                            textColor="success" .equals(messageType) ? "#155724" : "#721c24" ; String
                            borderColor="success" .equals(messageType) ? "#c3e6cb" : "#f5c6cb" ; %>
                            <div
                                style="background-color: <%= bgColor %>; color: <%= textColor %>; border: 1px solid <%= borderColor %>; padding: 1rem; border-radius: 4px; margin-bottom: 1.5rem;">
                                <%= message %>
                            </div>
                            <% } %>
                                ...
                                <div class="search-bar">
                                    <input type="text" class="search-input" placeholder="搜索歌曲名、艺术家或专辑..."
                                        id="songSearch">
                                ...
                                <div style="overflow-x: auto;">
                                    <table class="songs-table" id="songsTable">
                                        ...
                                        <tbody>
                                            <% if (songs !=null && !songs.isEmpty()) { for (Song song : songs) { %>
                                                <tr>
                                                    <td class="song-id">#<%= song.getId() %>
                                                    </td>
                                                    <td><strong>
                                                            <%= song.getTitle() %>
                                                        </strong></td>
                                                    ...
                                                    <td>
                                                        <div class="song-actions">
                                                            <button class="btn-small btn-play"
                                                                onclick="playSong(<%= song.getId() %>, '<%= song.getTitle() %>')">
                                                                ▶️ 播放
                                                            </button>
                                                            <button class="btn-small btn-view"
                                                                onclick="viewSongDetails(<%= song.getId() %>)">
                                                                👁️ 详情
                                                            </button>
                                                            <button class="btn-small btn-danger"
                                                                onclick="deleteSong(<%= song.getId() %>, '<%= song.getTitle() %>')">
                                                                🗑️ 删除
                                                            </button>
                                                        </div>
                                                    </td>
