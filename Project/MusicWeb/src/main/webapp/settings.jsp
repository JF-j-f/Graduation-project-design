...
<%
    ...
    String messageType = request.getParameter("messageType"); // success, error
    ...
    <div class="settings-container">
        ...
        <div class="settings-content">
            ...
            <div class="tab-content active" id="profile-tab">
                ...
                <form id="profileForm" action="updateProfile" method="post" class="settings-form">
            ...
            <div class="tab-content" id="security-tab">
                ...
                <form id="passwordForm" action="changePassword" method="post" class="settings-form">
                    <div class="form-section">
                        <h3>修改密码</h3>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" id="currentPassword" name="currentPassword"
                                   class="form-input" placeholder="请输入当前密码" required>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="password" id="newPassword" name="newPassword"
                                       class="form-input" placeholder="请输入新密码" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" id="confirmPassword" name="confirmPassword"
                                       class="form-input" placeholder="请再次输入新密码" required>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-section">
                    ...
                    <div class="account-info">
                        ...
                        <div class="info-item">
                            ...
                            <span class="info-value"><%= user.getCreateTime() != null ?
                                           user.getCreateTime().substring(0, 16) : "未知时间" %></span>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="password-confirmation">
                ...
                <input type="password" id="deletePasswordConfirm"
                       class="form-input" placeholder="输入当前密码">
